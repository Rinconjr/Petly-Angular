...
@Component({
  selector: 'app-admin-modificar-cliente',
  templateUrl: './admin-modificar-cliente.component.html',
  styleUrls: ['./admin-modificar-cliente.component.css']
})
export class AdminModificarClienteComponent implements OnInit {
  constructor(
