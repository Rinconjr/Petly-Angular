...
@Component({
  selector: 'app-admin-modificar-mascota',
  templateUrl: './admin-modificar-mascota.component.html',
  styleUrls: ['./admin-modificar-mascota.component.css']
})
export class AdminModificarMascotaComponent implements OnInit {
  constructor(
